...
import Unidad3.MascotaVirtual1.src.RatoncitoFiuFiu;
...
public class DuenoIGU extends JFrame {
    ...
    class Envejecimiento extends TimerTask {
        ...
        protected void animacion() {
            ...
            Integer tramoEdad = new Integer(mascota.queTramoEdad());
            String rutaImagenes;
    ...
    //Construir el marco
    public DuenoIGU() {
        mascota = new RatoncitoFiuFiu("Ratatouille", 50, (byte) 50, (byte) 50, (byte) 40, (byte) 100, (byte) 100);
        ...
        try {
            jbInit();
            this.setTitle("RatoncitoFiuFiu : ratatouille");
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
